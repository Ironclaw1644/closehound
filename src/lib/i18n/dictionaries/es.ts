...
export const es: Dictionary = {
  ...
  home: {
    ...
    heroSubTail: ". Extraemos las rentas de los vales de HUD, evaluamos cada propiedad y las clasificamos por Puntuación de Oferta — en los 50 estados, calificadas para que nunca desperdicies un crédito.",
    ctaPrimary: "Empieza gratis — 100 créditos",
    ...
    trustCards: [
      ...
      { title: "No puedes gastar de más", body: "Cada crédito se descuenta de tu plan. Cuando se acaban, el análisis se pausa — mejora tu plan o consigue un paquete de créditos. Nunca acumularás un cargo que no puedas ver." },
    ...
    pricingSub: "Empieza con 100 créditos gratis — unos 10 mercados, sin tarjeta. Compra más sobre la marcha, o suscríbete cuando caces cada semana. Sin sorpresas por exceso, nunca.",
    mostPopular: "Más popular",
    perMonth: "/mes",
    screensPerMonth: "créditos / mes",
    ...
    faq: [
      ...
      { q: "¿Puedo acumular una factura sorpresa?", a: "No. Cada crédito se descuenta de tu plan. Cuando se acaban, el análisis simplemente se pausa hasta que mejores tu plan o compres un paquete de créditos. Nunca podrás acumular un cargo que no puedas ver." },
    ...
    finalSub: "Usa tus primeros 100 créditos gratis y encuentra hoy tu primera oferta en un mercado principal.",
  ...
  howItWorks: {
    ...
    gradesSub: "No malgastaremos tus créditos. Cada mercado recibe una calificación de flujo de caja de la A a la F para que dediques tu tiempo donde el vale supera de forma fiable al mercado — y evites las trampas de apreciación.",
    ...
    cta: "Empieza gratis — 100 créditos",
    grades: {
  ...
  pricing: {
    ...
    perMonthShort: "/mes",
    perYearShort: "/año",
    screensOneTime: "créditos, pago único",
    screensPerMonth: "créditos / mes",
    get: "Obtén",
    ...
    disclaimer: "Garantía de devolución de 30 días — encuentra una oferta que valga la pena o te devolvemos el dinero. Sin cargos sorpresa: si se te acaban los créditos, el analizador se pausa hasta que mejores tu plan. Cancela cuando quieras.",
  },

  plans: {
    free: { blurb: "Encuentra tu primera oferta. Sin tarjeta.", features: ["100 créditos gratis", "Los 50 estados + calificaciones honestas A–F", "Impuesto real por propiedad + Puntuación de Oferta"] },
    hunter: { blurb: "El plan de cada día — analiza sin límites, todas las funciones.", features: ["1,000 créditos / mes", "Guarda + sigue ofertas (pipeline)", "Impuesto real por propiedad + comparables de última venta", "Guía de Sección 8 + soporte por correo"] },
    closer: { blurb: "Maneja volumen en varios mercados.", features: ["5,000 créditos / mes", "Exportación masiva a CSV + lote multimercado", "Acceso anticipado a nuevos mercados", "Soporte prioritario"] },
    agency: { blurb: "Para fondos y equipos que despliegan capital a escala.", features: ["25,000 créditos / mes", "Asientos de equipo", "Actualización de datos prioritaria", "Todo lo de Closer"] },
  },
  ...
  legal: {
    ...
    privacy: {
      ...
      sections: [
        { h: "Qué recopilamos", p: [
          "Datos de la cuenta: tu dirección de correo electrónico y detalles de autenticación (gestionados por Supabase). Datos de uso: los mercados y códigos postales que analizas y tu número de créditos, para poder medir tu plan. Datos de facturación: registros de suscripción y compra (gestionados por Stripe — nunca almacenamos números de tarjeta completos).",
        ] },
        { h: "Cómo lo usamos", p: [
  ...
  app: {
    ...
    errors: {
      outOfScreensRun: "Sin créditos este período — mejora tu plan o compra un paquete de créditos para seguir.",
      screenFailed: "El análisis falló. Inténtalo de nuevo.",
      outOfScreensListings: "Sin créditos — mejora tu plan o compra un paquete de créditos para seguir.",
    ...
    quota: {
      screensLeft: "créditos restantes", oneLeft: "crédito restante", credits: "{n} créditos", help: "Cómo funciona",
    },
    onboarding: {
      ...
      steps: [
        ...
        { n: "02", title: "Ejecuta el análisis", body: "CloseHound obtiene el alquiler real del vale de HUD y las propiedades a la venta en vivo de cada código postal del mercado — eso es alrededor de un crédito por código postal." },
      ...
      footer: "Tienes 100 créditos gratis este mes — unos 10 mercados. Sin tarjeta.",
    ...
    account: {
      ...
      membership: "Membresía", signedInAs: "Sesión iniciada como", screensThisMonth: "Créditos este mes",
      monthlyLeft: "créditos mensuales restantes · se reinicia al comienzo del próximo mes.", paygCredits: "Créditos de pago por uso",
      paygSub: "Se usan automáticamente cuando se acaban tus créditos mensuales. Nunca caducan.",
    ...
    login: {
      ...
      signInSub: "Analiza mercados y guarda ofertas.", createSub: "100 créditos gratis — unos 10 mercados. Sin tarjeta.",
